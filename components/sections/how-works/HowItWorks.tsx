...
export default function HowItWorks() {
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute top-0 left-0 size-[32rem] -translate-x-1/2 -translate-y-1/3 hidden rounded-full bg-[radial-gradient(circle,rgba(20,184,166,0.09),transparent_68%)] md:block"
      />

      <div
        aria-hidden="true"
        className="pointer-events-none absolute right-0 bottom-0 size-[28rem] translate-x-1/2 translate-y-1/3 hidden rounded-full bg-[radial-gradient(circle,rgba(56,189,248,0.06),transparent_68%)] md:block"
      />
